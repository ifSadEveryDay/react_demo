...
if (pnp) {
  ...
  cesiumSource = 'node_modules/@smart/cesium';
}
    ...
    if (loadPartially) {
      ...
      webpackConfig.plugins.push(
        new CopyWebpackPlugin([
          ...
          {
            from: path.join(cesiumSource, './Build/Cesium/ThirdParty/Assets'),
            to: path.join(cesiumPath, 'Assets')
          },
          {
            from: path.join(cesiumSource, './Build/Cesium/ThirdParty/Widgets'),
